...
phase2_GE0.toModify( theMixObjects,
    mixSH = dict(
        input = list(filter(lambda x: type(x) == type(cms.InputTag("","")) and x != cms.InputTag("g4SimHits","MuonME0Hits"), theMixObjects.mixSH.input)),# and x != cms.InputTag("g4SimHits","MuonGEMHits")  #type(x) == type(cms.vstring("")) and 
